...
def removed_punctuation(data):
    ...
    data['reviews'] = removedPunctuation_text
    return data
...
def remove_stopwords(sentence, stopwords_data):
    ...
    more_words = [ "hw","won't","lpu","weren't","mr","mcq","shes", "doe","shes","india","in","hes","shes","me", "dr", "nlandu", "ko","it","1st", "omr", "ha", "upto","ca", "soo", "cd", "ive","po","cse", "chem", "un","of",
...
sentences, labels = random_sampling(data)
